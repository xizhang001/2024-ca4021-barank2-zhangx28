-- This file contains Pig Latin code used to pre-process and clean data in order to create data/data_for_queries.

------------------------------------------------------------------------------------------------------------------------------------------
-- Load EV demand dataset
DEFINE CSVLoader org.apache.pig.piggybank.storage.CSVLoader();
DEFINE CSVExcelStorage org.apache.pig.piggybank.storage.CSVExcelStorage();
station_data = LOAD 'tests/data/raw_data/Palo_Alto_EV_Data.csv' USING CSVLoader();
...
station_clusters_data = LOAD 'tests/data/raw_data/Palo_Alto_Station_Clusters_Data.csv' USING CSVLoader();
...
------------------------------------------------------------------------------------------------------------------------------------------
-- Store dataset
STORE final_table INTO 'tests/data/data_for_queries' USING CSVExcelStorage();
